...
urlpatterns = [
    ...
    path(
        "post/create", views.PostCreateView.as_view(), name="PostCreateView"
    ),
    path(
        "post/<int:pk>/update/", views.UpdatePost.as_view(), name="UpdatePost"
    ),
    path(
        "post/<int:pk>/delete/", views.DeletePost.as_view(), name="DeletePost"
    ),
